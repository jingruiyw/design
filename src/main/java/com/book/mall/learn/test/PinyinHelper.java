...
/**
 * ClassName: PinyinHelper
 * Description:
 * date: 2020/4/14 1:06 下午
 *
 * @author: Jingrui
 * @since JDK 1.8
 */
...
public class PinyinHelper {
    ...
    public static void main(String[] args) {
        String jr = converterToFirstSpellNew("解开");
//        String str = converterToFirstSpell("啊   荆");
...
//        System.out.println(str);
     ...
     * @return 拼音
     */
    public static String converterToFirstSpellNew(String chines) {
